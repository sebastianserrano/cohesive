...
class SettingsViewController: UIViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate  {
    ...
    override func viewDidLoad() {
        ...
        UpdatePassButton.layer.cornerRadius = 5
        UpdatePassButton.backgroundColor = UIColor(red: 0/255.0, green: 169/255.0, blue: 157/255.0, alpha: 1.0)
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : Any]) {
        self.ProfilePhoto.image = (info[UIImagePickerControllerEditedImage] as! UIImage)
    ...
    @IBAction func updatePasswords(_ sender: Any) {
    ...
    func reset() {
        ...
        self.SkillTwoText = self.SkillTwo.text!
        self.SkillOneText = self.SkillOne.text!
        self.SkillThreeText = self.SkillThree.text!
        
    }
    
    fileprivate func loadSettingsUserDetails () {
    ...
    fileprivate func updateSkills(callback: @escaping (_ success: Bool, _ message:String) -> Void) {
    ...
    fileprivate func updatePicture(callback: @escaping (_ success: Bool, _ message: String) -> Void) {
