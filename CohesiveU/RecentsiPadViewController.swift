//
//  RecentsiPadViewController.swift
//  CohesiveU
//
...
class RecentsiPadViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        guard (REACHABLE.connectedToNetwork()) else {ProgressHUD.showError("Please connect to the network in order to view you matches");return}
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "iPadTableViewCellTwo", for: indexPath) as! iPadTableViewCellTwo
