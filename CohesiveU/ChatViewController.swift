...
class ChatViewController: JSQMessagesViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate, UIGestureRecognizerDelegate, IQAudioRecorderViewControllerDelegate {
    
    fileprivate let appDelegate = UIApplication.shared.delegate as! AppDelegate
    fileprivate let ref = FIREBASE.child("Message")
    
    fileprivate var messages: [JSQMessage] = [JSQMessage]()
    fileprivate var objects: [NSDictionary] = [NSDictionary]()
    fileprivate var loaded: [NSDictionary] = [NSDictionary]()
